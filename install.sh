...
echo "  ${BLUE}3.${NC} 以下のいずれかを有効にする:"
echo "       • ctrl-j: IME ON with Romaji conversion (advanced)"
echo "       • ctrl-j: IME ON, Enter: IME OFF (modeless style - simple)"
echo ""

echo -e "${YELLOW}アクセシビリティ権限の設定（高度版のみ必要）:${NC}"
echo ""
